...
J.Records.stallMod = Number(pluginParams['stallMod']) || 300; 
  ...
  Window_Record.prototype.drawListItem = function(i, x, y) {
    ...
    switch (i._type) {
      case 0: // for items
        ...
        this.drawText(i._name + " encontrado.", x + 32, y, w);
      break;
      case 1: // for experience
        this.drawIcon(2672, x, y);
        this.drawText(i._name + " experiencia ganada.", x + 32, y, w);
      break;
      case 2: // gold
        this.drawIcon(2656, x, y);
        this.drawText(i._name +' guardado', x + 32, y, w)
      break;
