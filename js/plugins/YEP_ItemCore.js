...
Window_ItemCategory.prototype.windowWidth = function() {
    if (SceneManager._scene instanceof Scene_Item) return 460;
...
Window_ItemCategory.prototype.numVisibleRows = function() {
    if (SceneManager._scene instanceof Scene_Item) return 1;//return 4;
...
Scene_Item.prototype.createActionWindow = function() {
    ...
    this._itemActionWindow = new Window_ItemActionCommand(0, 510);
...
Scene_Item.prototype.onActionUse = function() {
    ...
    //this.determineItem();
    //$gameParty.setItemObject(this.item());
    $gameActors.actor(1).useItem(this.item());
    this.playSeForItem();
    this.applyItem();
