...
Imported.OcRam_Core = true; let $temp_OcRam_Core_Ver = "1.16";
// This is for my webparser // OcRam.addPlugin("Core", "1.16");

/*:
 * @target MZ
 * @plugindesc v1.16 Core plugin for other OcRam -plugins.
