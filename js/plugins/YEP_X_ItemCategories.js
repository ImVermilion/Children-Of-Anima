...
Window_ItemCategory.prototype.addItemCategory = function(category) {
  ...
  if(type == "Food Only")  {
        return this.addCommand("Food", 'Category', true, type);
  }
  else if(type == "Books Only"){
        return this.addCommand("Text", 'Category', true, type);
  }
  else{
      return this.addCommand(type, 'Category', true, type);
  }
  ...
  //  return this.addCommand( TextManager.keyItem, 'keyItem');
    return this.addCommand( "Misc", 'keyItem');
